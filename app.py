...
DRAWING_AREA_H = PAGE_H_MM - TOP_MARGIN - BOTTOM_MARGIN 
# move the left drawing area down a bit to create header breathing space
DRAWING_ORIGIN_X = LEFT_MARGIN + 2
DRAWING_ORIGIN_Y = BOTTOM_MARGIN 
INFO_COL_X = DRAWING_ORIGIN_X + DRAWING_AREA_W 
...
if st.button("Generate A3 PDF"):
   ...
   # Site boundary with custom dashed line pattern
    site_rect = mpatches.Rectangle(
        ...
        fill=False,
        lw=LW_SITE,
        linestyle=(0, (12, 4, 3, 4, 3, 4)),   # custom dash: ____ _ _ ____ pattern
    )
